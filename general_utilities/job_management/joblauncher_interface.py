...
class JobInfo(TypedDict):
    """A TypedDict containing job information generated by the :func:`SubjobUtility()` class, not provided by DNANexus.
    ...
    :cvar instance_type: Optional requested instance type, must match available DNANexus instance types.
    """
    function: Callable
...
class JobLauncherInterface(ABC):
    ...
    def launch_job(self,
        ...
        :param outputs: A list of output files to be generated by the job.
